...
class RobotState {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize the length for message field [motor_state]
    bufferOffset = _serializer.uint32(obj.motor_state.length, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize array length for message field [motor_state]
  ...
  static getMessageSize(object) {
    let length = 0;
    length += 20 * object.motor_state.length;
    return length + 44;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.motor_state !== undefined) {
      resolved.motor_state = new Array(msg.motor_state.length);
