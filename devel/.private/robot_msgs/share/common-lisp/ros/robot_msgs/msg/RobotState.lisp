...
(cl:defclass <RobotState> (roslisp-msg-protocol:ros-message)
  ((imu
   ...
   :initform (cl:make-array 0 :element-type 'robot_msgs-msg:MotorState :initial-element (cl:make-instance 'robot_msgs-msg:MotorState))))
)
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <RobotState>) ostream)
  ...
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'motor_state))))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <RobotState>) istream)
  ...
  (cl:setf (cl:slot-value msg 'motor_state) (cl:make-array __ros_arr_len))
...
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <RobotState>))
  (cl:+ 0
     ...
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'motor_state) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ (roslisp-msg-protocol:serialization-length ele))))
))
